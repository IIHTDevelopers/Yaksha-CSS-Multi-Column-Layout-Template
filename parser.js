...
const htmlTagsTestCase = {
    ...
    extraParams: [['html', 'body', 'title', 'div', 'p']]
};
...
const requiredStyles = [
    {
        ...
        properties: [
            { key: 'column-count', value: '3' },
            { key: 'column-gap', value: '20px' }
        ]
    }
];

const cssTestCase = {
    testCaseName: 'CSS multi-column Styles Test',
    testCaseType: 'boundary',
...
const htmlAttributesTestCase = {
    ...
    extraParams: [[
        { tag: 'div', attribute: 'class', value: 'multi-column' }
    ]]
};
